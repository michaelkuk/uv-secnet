...
*/
  ...
  inline std::string base64_encode(std::string& data) {
    return base64_encode(const_cast<unsigned char*>(reinterpret_cast<const unsigned char*>(data.c_str())), data.length());
  }
